...
namespace Telerik.WinControls.CompositeUI
{
        ...
        WindowsFormsApplication<TWorkItem, TShell> where TWorkItem : WorkItem, new()
    {
        ...
        protected override void AfterShellCreated()
        {
            ...
            catalog.RegisterFactory(new RadCommandBarUIAdapterFactory());
            catalog.RegisterFactory(new RadRibbonBarUIAdapterFactory());
            catalog.RegisterFactory(new RadItemCollectionAdapterFactory());
        }
