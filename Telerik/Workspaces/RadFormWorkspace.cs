...
{
    public class RadFormWorkspace : Workspace<Control, WindowSmartPartInfo>
    {
        ...
        public RadFormWorkspace(IWin32Window ownerForm)
		{
		...
		/// WindowForm class
		/// </summary>
		private class WindowForm : RadForm
		{
			/// <summary>
