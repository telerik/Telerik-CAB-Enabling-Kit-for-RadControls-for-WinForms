...
namespace FinanceApplicationCAB.Infrastructure.Interface
{
	...
	public abstract class WorkItemController : IWorkItemController
	{
		...
		protected virtual TView ShowViewInWorkspace<TView>(string viewId, string workspaceName, ISmartPartInfo smartPartInfo)
		{
			TView view = default(TView);
			if (WorkItem.SmartParts.Contains(viewId))
			{
			...
			WorkItem.Workspaces[workspaceName].Show(view, smartPartInfo);
