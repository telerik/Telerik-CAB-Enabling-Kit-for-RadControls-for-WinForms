...
namespace FinanceApplicationCAB.Infrastructure.Module
{
	public class StockItemElement : RadItem
	{
		...
		protected override void OnClick(EventArgs e)
		{
            ...
            RadPageView panelBar = this.ElementTree.Control as RadPageView;
			if (panelBar != null)
			{
				panelBar.ViewElement.SetValue(StockItemElement.SelectedItemProperty, this);
			}
		}
		...
		protected override void OnMouseEnter(EventArgs e)
		{
			...
			if (panelBar != null)
			{
                panelBar.ViewElement.SetValue(StockItemElement.HoveredItemProperty, this);
			}
		}
		...
		protected override void OnMouseLeave(EventArgs e)
		{
			...
			if (panelBar != null)
			{
                panelBar.ViewElement.SetValue(StockItemElement.HoveredItemProperty, null);
			}
		}
	}
}
